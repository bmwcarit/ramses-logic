...
namespace rlogic
{
    ...
    */
    ...
    public:
        ...
        */
        [[nodiscard]] RLOGIC_API std::chrono::microseconds getTopologySortExecutionTime() const;
        ...
        */
        [[nodiscard]] RLOGIC_API std::chrono::microseconds getTotalUpdateExecutionTime() const;
        ...
        */
        [[nodiscard]] RLOGIC_API size_t getTotalLinkActivations() const;

        /**
        * Default constructor of LogicEngineReport.
        */
        RLOGIC_API LogicEngineReport() noexcept;
        ...
        */
        RLOGIC_API explicit LogicEngineReport(std::unique_ptr<internal::LogicEngineReportImpl> impl) noexcept;

        /**
        * Class destructor
        */
        RLOGIC_API ~LogicEngineReport();
        ...
        * @param other source
        */
        RLOGIC_API LogicEngineReport(LogicEngineReport&& other) noexcept;
        ...
        * @param other source
        */
        RLOGIC_API LogicEngineReport& operator=(LogicEngineReport&& other) noexcept;
