...
namespace rlogic::internal
{
    ...
    public:
            ...
            : ALogicEngine{ EFeatureLevel_05 }
        {
            ...
            const ramses::ArrayResource* vertexPositions = m_scene->createArrayResource(ramses::EDataType::Vector3F, 3, vertexPositionsArray.data());
            const std::array<int32_t, 3u> indexArray = { 0, 1, 2 };
            const ramses::ArrayResource* indices = m_scene->createArrayResource(ramses::EDataType::UInt32, 3, indexArray.data());
