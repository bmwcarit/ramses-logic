...
SceneAndNodes CreateSceneWithTriangles(ramses::RamsesClient& client)
{
    ...
    std::array<float, 9u> vertexPositionsArray = { -1.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 1.f, 0.f };
    ...
    appearanceRed->setInputValueVector4f(colorInput, 1, 0, 0, 0.5f);
    ramses::Appearance* appearanceWhite = scene->createAppearance(*effect);
    appearanceWhite->setInputValueVector4f(colorInput, 1, 1, 1, 0.5f);
