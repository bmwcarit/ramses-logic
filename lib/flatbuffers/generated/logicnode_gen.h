...
struct LogicNode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const rlogic_serialization::Property *inputs() const {
    return GetPointer<const rlogic_serialization::Property *>(VT_INPUTS);
  }
  const rlogic_serialization::Property *outputs() const {
    return GetPointer<const rlogic_serialization::Property *>(VT_OUTPUTS);
  }
...
struct LogicNodeBuilder {
  ...
  void add_inputs(flatbuffers::Offset<rlogic_serialization::Property> inputs) {
    fbb_.AddOffset(LogicNode::VT_INPUTS, inputs);
  }
  void add_outputs(flatbuffers::Offset<rlogic_serialization::Property> outputs) {
...
inline flatbuffers::Offset<LogicNode> CreateLogicNode(
    ...
    flatbuffers::Offset<rlogic_serialization::Property> inputs = 0,
    flatbuffers::Offset<rlogic_serialization::Property> outputs = 0) {
...
inline const rlogic_serialization::LogicNode *GetLogicNode(const void *buf) {
  return flatbuffers::GetRoot<rlogic_serialization::LogicNode>(buf);
}

inline const rlogic_serialization::LogicNode *GetSizePrefixedLogicNode(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<rlogic_serialization::LogicNode>(buf);
}

inline bool VerifyLogicNodeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<rlogic_serialization::LogicNode>(nullptr);
}

inline bool VerifySizePrefixedLogicNodeBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<rlogic_serialization::LogicNode>(nullptr);
}

inline void FinishLogicNodeBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<rlogic_serialization::LogicNode> root) {
  fbb.Finish(root);
}
