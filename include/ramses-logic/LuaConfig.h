...
namespace rlogic
{
    ...
    public:
         ...
         */
        RLOGIC_API bool addDependency(std::string_view aliasName, const LuaModule& moduleInstance);
         ...
         */
        RLOGIC_API LuaConfig(const LuaConfig& other);

        /**
         * Move Constructor of #LuaConfig
         * @param other the other #LuaConfig to move from
         */
        RLOGIC_API LuaConfig(LuaConfig&& other) noexcept;
         ...
         * @return self
         */
        RLOGIC_API LuaConfig& operator=(const LuaConfig& other);
         ...
         * @return self
         */
        RLOGIC_API LuaConfig& operator=(LuaConfig&& other) noexcept;
